...
function onMapMoveEnd() {
  // If a popup is open but scrolled out of view, unsuppress the search button
  if (searchBtnSuppressed && state.map._popup) {
    const popupLatLng = state.map._popup.getLatLng();
    if (popupLatLng && !state.map.getBounds().contains(popupLatLng)) {
